...
const SelectedDonationCard = ({donation}) => {
    const {picture, category, category_bg, card_bg, text_color, title, price} = donation
    return (
        <div style={{background: card_bg}} className='flex gap-6 items-center rouded-lg'>
            ...
            <button style={{background: text_color}} className='text-white font-semibold md:text-lg px-4 py-2 rounded-md'>View Details</button>
            </div>
        </div>
    );
};
